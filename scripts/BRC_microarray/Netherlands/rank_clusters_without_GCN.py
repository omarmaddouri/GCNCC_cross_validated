...
with open("{}{}.top_features_without_GCN.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
...
with open("{}{}.final_features_without_GCN.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
