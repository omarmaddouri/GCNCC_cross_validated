...
with open("{}{}.top_features_iterativeWGCNA.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
...
with open("{}{}.final_features_iterativeWGCNA.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
