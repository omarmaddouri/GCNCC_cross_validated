...
def prepare_enrichment_clusters(dataset="PPI"):
    ...
    Ids = np.genfromtxt("../../data/BRC_microarray/output/USA/PPI.ids.txt", dtype=np.dtype(str), delimiter="\t")
    gene_ids = {}
    for i in range(Ids.shape[0]):
        gene_ids[Ids[i,1]]=Ids[i,0]
        
    Clusters = open("../../data/BRC_microarray/output/USA/PPI.clusters.txt", encoding="utf-8")
    with open("../../data/BRC_microarray/output/USA/PPI.enrichment.txt", "w", newline='', encoding="utf-8") as f:
...
def prepare_enrichment_clusters_without_GCN(dataset="PPI"):
    ...
    Clusters = open("../../data/BRC_microarray/output/USA/PPI.clusters_without_GCN.txt", encoding="utf-8")
    with open("../../data/BRC_microarray/output/USA/PPI.enrichment_without_GCN.txt", "w", newline='', encoding="utf-8") as f:
        w_cluster = csv.writer(f, delimiter ='\t')
        for line in Clusters:
            line = line.strip()
            columns = line.split("\t")
...
def prepare_enrichment_clusters_without_GCN_and_local_modules(dataset="PPI"):
    ...
    Clusters = open("../../data/BRC_microarray/output/USA/PPI.clusters_without_GCN_and_local_modules.txt", encoding="utf-8")
    with open("../../data/BRC_microarray/output/USA/PPI.enrichment_without_GCN_and_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_cluster = csv.writer(f, delimiter ='\t')
        for line in Clusters:
            line = line.strip()
            columns = line.split("\t")
...
def prepare_enrichment_clusters_without_local_modules(dataset="PPI"):
    ...
    Clusters = open("../../data/BRC_microarray/output/USA/PPI.clusters_without_local_modules.txt", encoding="utf-8")
    with open("../../data/BRC_microarray/output/USA/PPI.enrichment_without_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_cluster = csv.writer(f, delimiter ='\t')
        for line in Clusters:
            line = line.strip()
            columns = line.split("\t")
...
def prepare_entrez_ensembl_mapping():
    ...
    with open("../../data/BRC_microarray/output/USA/PPI.ensembl.entrez.txt", "w", newline='', encoding="utf-8") as f:
...
def prepare_PPI_gene_expression():
    ...
    for i in range(PPI.shape[0]):
        ...
        if(ENSP not in protein_ids):
            ...
            p_id+=1
    with open("../../data/BRC_microarray/output/USA/PPI.ids.txt", "w", newline='', encoding="utf-8") as f:
        w_indices = csv.writer(f, delimiter ='\t')
        for key, val in protein_ids.items():
            w_indices.writerow([key, val])
            
    #Map Gene IDs to Protein IDs
    MAP = np.genfromtxt("../../data/BRC_microarray/input/probes_protein.txt", skip_header=1, dtype=np.dtype(str), delimiter="\t")
    ...
    with open("../../data/BRC_microarray/output/USA/PPI.adjacency.matrix", "w", newline='', encoding="utf-8") as f:
    ...
    GE = np.genfromtxt("../../data/BRC_microarray/input/USA/GSE2034_series_matrix.txt", skip_header=55, skip_footer=1, dtype=np.dtype(str), delimiter="\t")
    ...
    with open("../../data/BRC_microarray/output/USA/PPI.GE_Features.txt", "w", newline='', encoding="utf-8") as f:
...
def prepare_clusters_AP(labels, cluster_centers_indices):
    ...
    with open("../../data/BRC_microarray/output/USA/PPI.clusters.txt", "w", newline='', encoding="utf-8") as f:
...
def prepare_clusters_AP_without_GCN(labels, cluster_centers_indices):
    ...
    for i in range(len(labels)):
        clusters["Center_{}".format(cluster_centers_indices[labels[i]])].append(i)
    with open("../../data/BRC_microarray/output/USA/PPI.clusters_without_GCN.txt", "w", newline='', encoding="utf-8") as f:
        w_clusters = csv.writer(f, delimiter ='\t')
        for key, val in clusters.items():
            line = []
            line.append(key)
...
def prepare_clusters_AP_without_GCN_and_local_modules(labels, cluster_centers_indices):
    ...
    for i in range(len(labels)):
        clusters["Center_{}".format(cluster_centers_indices[labels[i]])].append(i)
    with open("../../data/BRC_microarray/output/USA/PPI.clusters_without_GCN_and_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_clusters = csv.writer(f, delimiter ='\t')
        for key, val in clusters.items():
            line = []
            line.append(key)
...
def prepare_clusters_AP_without_local_modules(labels, cluster_centers_indices):
    ...
    for i in range(len(labels)):
        clusters["Center_{}".format(cluster_centers_indices[labels[i]])].append(i)
    with open("../../data/BRC_microarray/output/USA/PPI.clusters_without_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_clusters = csv.writer(f, delimiter ='\t')
        for key, val in clusters.items():
            line = []
            line.append(key)
