...
clust = np.genfromtxt("{}{}.final_features_Netherlands_FS.txt".format(path, dataset), dtype=np.dtype(np.int))
...
plt.title('BREAST CANCER: USA-[Netherlands + feature selection]')
