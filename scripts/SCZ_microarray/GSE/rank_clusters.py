...
with open("{}{}.top_features.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
...
with open("{}{}.final_features.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
