...
with open("{}{}.top_features_syn4590909_FS.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
...
with open("{}{}.final_features_syn4590909_FS.txt".format(path, dataset), "w", newline='', encoding="utf-8") as f:
