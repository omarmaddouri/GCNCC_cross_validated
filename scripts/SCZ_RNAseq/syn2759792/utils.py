...
def prepare_enrichment_clusters(dataset="PPI"):
    ...
    Ids = np.genfromtxt("../../data/SCZ_RNAseq/output/syn2759792/PPI.ids.txt", dtype=np.dtype(str), delimiter="\t")
    gene_ids = {}
    for i in range(Ids.shape[0]):
        gene_ids[Ids[i,1]]=Ids[i,0]
        
    Clusters = open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters.txt", encoding="utf-8")
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.enrichment.txt", "w", newline='', encoding="utf-8") as f:
...
def prepare_enrichment_clusters_without_GCN(dataset="PPI"):
    ...
    Clusters = open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters_without_GCN.txt", encoding="utf-8")
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.enrichment_without_GCN.txt", "w", newline='', encoding="utf-8") as f:
        w_cluster = csv.writer(f, delimiter ='\t')
        for line in Clusters:
            line = line.strip()
            columns = line.split("\t")
...
def prepare_enrichment_clusters_without_GCN_and_local_modules(dataset="PPI"):
    ...
    Clusters = open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters_without_GCN_and_local_modules.txt", encoding="utf-8")
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.enrichment_without_GCN_and_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_cluster = csv.writer(f, delimiter ='\t')
        for line in Clusters:
            line = line.strip()
            columns = line.split("\t")
...
def prepare_enrichment_clusters_without_local_modules(dataset="PPI"):
    ...
    Clusters = open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters_without_local_modules.txt", encoding="utf-8")
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.enrichment_without_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_cluster = csv.writer(f, delimiter ='\t')
        for line in Clusters:
            line = line.strip()
            columns = line.split("\t")
...
def prepare_entrez_ensembl_mapping():
    ...
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.ensembl.entrez.txt", "w", newline='', encoding="utf-8") as f:
...
def prepare_PPI_gene_expression():
    ...
    for i in range(PPI.shape[0]):
        ...
        if(ENSP not in protein_ids):
            ...
            p_id+=1
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.ids.txt", "w", newline='', encoding="utf-8") as f:
    ...
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.adjacency.matrix", "w", newline='', encoding="utf-8") as f:        
        w_adj = csv.writer(f, delimiter ='\t')
        for key, val in adj_matrix.items():
            for neighbor in val:
                w_adj.writerow([key, neighbor])
    #Prepare gene expression features    
    GE = np.genfromtxt("../../data/SCZ_RNAseq/input/syn2759792/CMC_MSSM-Penn-Pitt_DLPFC_mRNA_IlluminaHiSeq2500_geneExpressionRaw.tsv", skip_header=1, dtype=np.dtype(str), delimiter="\t")
    ...
    adjusted_indices = [y+1 for x in indices for y in x]
    ...
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.GE_Features.txt", "w", newline='', encoding="utf-8") as f:    
...
def prepare_clusters_AP(labels, cluster_centers_indices):
    ...
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters.txt", "w", newline='', encoding="utf-8") as f:
...
def prepare_clusters_AP_without_GCN(labels, cluster_centers_indices):
    ...
    for i in range(len(labels)):
        clusters["Center_{}".format(cluster_centers_indices[labels[i]])].append(i)
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters_without_GCN.txt", "w", newline='', encoding="utf-8") as f:
        w_clusters = csv.writer(f, delimiter ='\t')
        for key, val in clusters.items():
            line = []
            line.append(key)
...
def prepare_clusters_AP_without_GCN_and_local_modules(labels, cluster_centers_indices):
    ...
    for i in range(len(labels)):
        clusters["Center_{}".format(cluster_centers_indices[labels[i]])].append(i)
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters_without_GCN_and_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_clusters = csv.writer(f, delimiter ='\t')
        for key, val in clusters.items():
            line = []
            line.append(key)
...
def prepare_clusters_AP_without_local_modules(labels, cluster_centers_indices):
    ...
    for i in range(len(labels)):
        clusters["Center_{}".format(cluster_centers_indices[labels[i]])].append(i)
    with open("../../data/SCZ_RNAseq/output/syn2759792/PPI.clusters_without_local_modules.txt", "w", newline='', encoding="utf-8") as f:
        w_clusters = csv.writer(f, delimiter ='\t')
        for key, val in clusters.items():
            line = []
            line.append(key)
