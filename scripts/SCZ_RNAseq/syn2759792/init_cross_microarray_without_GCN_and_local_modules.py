...
dataset="PPI"
features = np.genfromtxt("../../data/SCZ_microarray/output/GSE/{}.GE_Features.txt".format(dataset), dtype=np.dtype(np.float32))
...
plt.title('SCZ: syn2759792-microarray (without GCN and local modules)')
