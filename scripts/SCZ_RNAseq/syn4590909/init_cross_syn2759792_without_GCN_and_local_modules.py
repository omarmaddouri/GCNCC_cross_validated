...
dataset="PPI"
features = np.genfromtxt("../../data/SCZ_RNAseq/output/syn2759792/{}.GE_Features.txt".format(dataset), dtype=np.dtype(np.float32))
...
plt.title('SCZ: syn4590909-syn2759792 (without GCN and local modules)')
